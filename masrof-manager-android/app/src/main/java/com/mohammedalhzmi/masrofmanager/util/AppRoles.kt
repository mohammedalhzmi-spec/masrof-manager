...
object RolePreferences {
    ...
    fun currentRole(context: Context): AppRole = UserSession.current?.role ?: runCatching { AppRole.valueOf(prefs(context).getString(ROLE, AppRole.ADMIN.name)!!) }.getOrDefault(AppRole.ADMIN)
